...
import { Upload, File, FileText, Image as ImageIcon, Video, Music, Archive } from 'lucide-react';
import { useState, useRef } from 'react';
import { useUploadFile, useGetFiles } from '../hooks/useQueries';
...
export default function FileUpload() {
  ...
  return (
    <section id="unggah" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Unggah sertifikat Anda dengan aman. Kami mendukung berbagai format file termasuk PDF, gambar, dan dokumen lainnya
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                size="lg"
              >
                {uploadMutation.isPending ? 'Mengunggah...' : 'Unggah Sertifikat Anda'}
              </Button>
            </CardContent>
          </Card>
